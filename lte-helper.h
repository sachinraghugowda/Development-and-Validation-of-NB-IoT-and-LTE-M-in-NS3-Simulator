...
public:
 ...
 // NetDeviceContainer InstallNbEnbDevice (NodeContainer c);              //monisha
  ...
  NetDeviceContainer InstallNbUeDevice (NodeContainer c);                      //monisha
  ...
  void NbAttach (NetDeviceContainer nbueDevice);                                           //sachin
  ...
  void NbAttach (Ptr<NetDevice> nbueDevice);                                              //sachin
  /**
  ...
  void NbAttach (NetDeviceContainer nbueDevices, Ptr<NetDevice> enbDevice);                //sachin
  ...
  void NbAttach (Ptr<NetDevice> nbueDevice, Ptr<NetDevice> enbDevice);                            //sachin
  /** 
  ...
  void NbAttachToClosestEnb (NetDeviceContainer nbueDevices, NetDeviceContainer enbDevices);                  //sachin
  ...
  void NbAttachToClosestEnb (Ptr<NetDevice> nbueDevice, NetDeviceContainer enbDevices);                       //sachin
...
private:
 ...
 // Ptr<NetDevice> InstallSingleNbEnbDevice (Ptr<Node> n);
  ...
  Ptr<NetDevice> InstallSingleNbUeDevice (Ptr<Node> n);               //monisha
