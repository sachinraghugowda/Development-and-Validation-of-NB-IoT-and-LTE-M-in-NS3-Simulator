...
LteUeRrc::GetNbiotUlBandwidth () const
{
  NS_LOG_FUNCTION (this);
  return m_nbiotUlBandwidth;
}                                                                     //sachin end
...
uint8_t                                                             //sachin start
LteUeRrc::GetNbiotDlBandwidth () const
{
  NS_LOG_FUNCTION (this);
  return m_nbiotDlBandwidth;
}                                                                     //sachin end
  ...
  if (msg.haveSib2)
    {
      switch (m_state)
       ...
       //   m_nbiotUlBandwidth = msg.sib2.freqInfo.nbiotUlBandwidth;                                                                             //sachin
          ...
          m_cphySapProvider->ConfigureUplink (m_ulEarfcn, m_ulBandwidth);     
              m_cphySapProvider->ConfigureNbiotUplink (m_nbiotUlBandwidth);                                                                //sachin 
      ...
      if (msg.haveMobilityControlInfo)
        {
          ...
          NS_ASSERT (mci.haveCarrierBandwidth);
             NS_ASSERT (mci.haveCarrierNbiotBandwidth);                                               //sachin                                                                                               
          ...
          m_cphySapProvider->ConfigureUplink (mci.carrierFreq.ulCarrierFreq, mci.carrierBandwidth.ulBandwidth);   //mci.carrierNbiotBandwidth.nbiotUlBandwidth );  
              m_cphySapProvider->ConfigureNbiotUplink (mci.carrierNbiotBandwidth.nbiotUlBandwidth);                                                                 //sachin
